...
exclude = [
  ...
  'bower_components/plone-mockup/tests/iframe-test.js',
  'bower_components/plone-mockup/tests/pattern-formunloadalert-test.js',
  'bower_components/plone-mockup/tests/pattern-preventdoublesubmit-test.js'
];
